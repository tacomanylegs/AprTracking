/**
 * MMT Finance 0.01% 池 Estimated APR 爬蟲
 * 使用方式:
 *   node mmt-0.01-monitor.js --once    # 單次查詢
 *   node mmt-0.01-monitor.js            # 持續監控
 *   node mmt-0.01-monitor.js --stats    # 查看統計
 */
...
async function main() {
  ...
  // 持續監控模式
  console.log('╔═══════════════════════════════════════════════════════════╗');
  console.log(`║    MMT Finance 0.01% APR 持續監控器                      ║`);
  console.log('╚═══════════════════════════════════════════════════════════╝\n');
